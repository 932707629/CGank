...
import com.soushin.cgank.widget.colorpicker.builder.ColorWheelRendererBuilder;
import com.soushin.cgank.widget.colorpicker.builder.PaintBuilder;
import com.soushin.cgank.widget.colorpicker.renderer.ColorWheelRenderOption;
import com.soushin.cgank.widget.colorpicker.renderer.ColorWheelRenderer;
import com.soushin.cgank.widget.colorpicker.slider.AlphaSlider;
import com.soushin.cgank.widget.colorpicker.slider.LightnessSlider;
...
public class ColorPickerView extends View {
    ...
    public int getSelectedColor() {
        int color = 0;
        if (currentColorCircle != null)
            color = ImageUtils.colorAtLightness(currentColorCircle.getColor(), this.lightness);
        return ImageUtils.adjustAlpha(this.alpha, color);
    }
    ...
    public void setInitialColor(int color, boolean updateText) {
        ...
        this.alpha = ImageUtils.getAlphaPercent(color);
    ...
    public void setLightness(float lightness) {
        ...
        this.initialColor = Color.HSVToColor(ImageUtils.alphaValueAsInt(this.alpha), currentColorCircle.getHsvWithLightness(lightness));
        if (this.colorEdit != null)
            this.colorEdit.setText(ImageUtils.getHexString(this.initialColor, this.alphaSlider != null));
    ...
    public void setAlphaValue(float alpha) {
        ...
        this.alpha = alpha;
        this.initialColor = Color.HSVToColor(ImageUtils.alphaValueAsInt(this.alpha), currentColorCircle.getHsvWithLightness(this.lightness));
        if (this.colorEdit != null)
            this.colorEdit.setText(ImageUtils.getHexString(this.initialColor, this.alphaSlider != null));
    ...
    private void setColorText(int argb) {
        if (colorEdit == null)
            return;
        colorEdit.setText(ImageUtils.getHexString(argb, this.alphaSlider != null));
    }
